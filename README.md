...
Forn those who desire to keep the terminal based approach, this repo contains an updated sketch for Fossasat-2 which includes some newer commands to interface with the satellite.
